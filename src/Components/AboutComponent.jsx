        ...
        >
          ...
          <ul className="space-y-6 text-lg leading-relaxed text-justify">
            {[
              <>
                I'm{" "}
                <span className="text-blue-500 font-semibold">Ramkumar</span>, a
                passionate Front-End Developer from{" "}
                <span className="text-blue-500">Tenkasi</span>. My journey into
                web development began with YouTube tutorials and W3Schools. With{" "}
                <span className="text-blue-500">6 months of experience</span>, I
                specialize in{" "}
              ...
              <>
                ...
                <span className="text-blue-500">Java Full Stack Developer</span>{" "}
              ...
              <>
                ...
                <span className="text-blue-500">3D animation with Blender</span>
                .
              </>,
            ].map((content, idx) => (
              <li
