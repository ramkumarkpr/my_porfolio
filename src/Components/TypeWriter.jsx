...
import "../styles/glow.css"; // must include this if it contains the star-bg styles
...
const TypeWritter = () => {
  ...
  return (
    <div className="star-bg">
      <div className="star-overlay"></div> {/* Optional sparkle effect */}
      <div className="w-full text-white px-4 py-8 relative z-10">
